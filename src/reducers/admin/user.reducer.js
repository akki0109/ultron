...
export function adminUsers(state = initialState, action) {
    ...
    case adminUserConstants.USERUPDATE_SUCCESS:
        ...
        console.log(user);
        // console.log("error profile----->",action.userInfo.data1.profileImage);
        if (action.userInfo.data1?.profileImage) {
            user.data.profileImage = action.userInfo.data1?.profileImage;

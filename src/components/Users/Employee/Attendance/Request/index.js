...
const Request = (props) => {
  ...
  const saveChanges = () => {
    const updatedData = {userId:props.userId,request_date:props.attendanceListDate, attendaceDetails: data };
    let arr = [];
    data.map((item) => {
      arr.push(
        moment
  ...
  return (
    <div>
      <Modal show={props.isOpen} onHide={"true"} className="small_modal">
        <Modal.Header>
          <Modal.Title>Regularization Request: {dateFormat(props.attendanceListDate,"fullDate")}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {/* <table width={"100%"}>
            <thead>
            ...
            <tbody>
              ...
              <td colSpan={3} align="center">
               <h5 className="text-danger"> Please Enter At Least One Record </h5>
              </td>
              </tr>}
              <tr>
                <td colSpan={2}>
                ...
                <td align="right" colSpan={1} className="mr-5">
                  <Button
                    variant="success"
                    className="mt-3 mr-2 btn-block btn-success"
                    onClick={addObject}
                    size="sm"
                  >
                    Add Time
          ...
          {data.length>0&&data?(<div className="row ">
            ...
            <div className="col-4">
              ...
              <div className="col-12" align="center">
               <div className="alert alert-danger text-center"> Please Enter At Least One Record </div>
              </div>
              </div>}
              <div className="row ">

...
class Index extends Component {
    ...
    getCasualLeaveData() {
        if (this.state.user) {
            this.props.dispatch(leaveActions.checkCasualLeaves({ _id: this.state.user.data._id }));
        }
    }
    getSickLeaveData() {
        if (this.state.user) {
            this.props.dispatch(leaveActions.checkSickLeaves({ _id: this.state.user.data._id }));
        }
    }
                            ...
                            <table id="main-table" className="main-table full-first-td">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" className="col-2">Request By</th>
                                    ...
                                    {LeavesRequestsList && LeavesRequestsList.map((item,  index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="text-center">
                                                {item.leaves.status == "pending" ?
                                                    <div className="action-area d-flex align-items-center justify-content-center">
                        ...
                        <ModalBody className="border-0">
                            ...
                            <div id="table-scroll" className="table-scroll h-auto popup_table my-3 modal_table">
                                <table id="main-table" className="main-table full-first-td">
                                    <thead>
                                        <tr>
                                            <th scope="col" className=" text-left">Requested Leave Date</th>
                                            <th scope="col" className="text-right">Type/Reason</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                        ...
                        <ModalBody className="border-0 text-center">
                            <div id="table-scroll" className="table-scroll h-auto popup_table my-3 modal_table">
                                <table id="main-table" className="main-table full-first-td">
                                    <thead>
                                        <tr>
                                            <th scope="col" className=" text-left">Leave Date</th>
                                            <th scope="col" className="text-right ">Type/Reason</th>
                                        </tr>
                                    </thead>
                                    <tbody>

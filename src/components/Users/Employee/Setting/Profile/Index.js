                                ...
                                <div className="form-group">
                                    ...
                                    <div className="mt-3">
                                        {this.state.editUserData.profileImage != "" &&
                                            <img className="" style={{ width: 200, height: "auto" }} alt="Cropped Img" src={this.state.editUserData.profileImage} />
                                        }
                                        {this.state.editUserData.profileImage == "" && this.state.editImage != "" &&
                                            <img className="" style={{ width: 200, height: "auto" }} alt="Cropped Img" src={this.state.editImage} />
                                        }
                                    </div>
                                </div>

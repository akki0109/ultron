                            ...
                            <table id="main-table" className="main-table full-first-td">
                                ...
                                <tbody>
                                    ...
                                    {this.state.filteredKeywords.length < 1 &&
                                        <tr>
                                            <td colSpan="5" className="text-center"> <div className="norecords">No Record</div> </td>
                                        </tr>
                                    }
                                </tbody>
                            </table>
                ...
                <Modal size="md" isOpen={this.state.deleteModal} toggle={() => this.closeDeleteModal()}>
                    ...
                    <ModalFooter>
                        <div className="d-flex justify-content-end w-100">
                            <button className="btn btn-secondary mr-3" onClick={this.closeDeleteModal}>Cancel</button>

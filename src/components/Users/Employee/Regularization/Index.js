      ...
      <div>
        ...
        <main className="offset">
          <div className="container-fluid hard-pad">
            ...
            <div id="table-scroll" className="table-scroll mt-4 pagination_mrg">
              <table
                id="main-table"
                className="main-table full-first-td"
              >
                <thead>
                  <tr>
                    ...
                    pendingList.map((item, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          ...
                          >
                            <div
                              className="text_eclip text-capitalize"
          ...
          {pendingList &&
            ...
            totalItemsCount != undefined && (
              <Pagination
                ...
                itemClass="page-item"
                linkClass="page-link"
                innerClass="pagination justify-content-center pt-5"
        ...
        >
          <div className="modal-content">
            <ModalHeader className="header-less ml-2"toggle={() => this.closeRejectModal()} > Regularization request </ModalHeader>

            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.section2}>
                    <View style={styles.columnParent}>
                        <View style={[styles.width30, {marginTop: 17,}]}>
                        ...
                        <View style={[styles.width70, styles.headertext]}>
                            ...
                            <Text style={[styles.paragraph, styles.font11]}>CIN - U72300HR2016PTCO58094</Text>
                        </View>
                    </View>
                </View>    
                    ...
                    <View style={[styles.box2, styles.margintop25]}>
                        <View style={styles.box46}>
                            ...
                            <View style={[styles.width100, styles.box2, styles.margintop48]}>
                                ...
                                <Text style={[styles.width30, styles.font10, styles.fw_bold, styles.textright]}>{INRFormate(props.userInfo.totalBHS)  }</Text>
                            </View>
                        </View>
                        <View style={styles.box46}>
                            <View>
                            ...
                            { props.userInfo.leaveDeducation >0 && 
                                <View style={[styles.width100, styles.box2, styles.margintop13]}>
                            ...
                            { props.userInfo.tdsDeducation >0 && 
                                <View style={[styles.width100, styles.box2, styles.margintop13]}>
                            ...
                            { props.userInfo.pf_check == true &&
                                <View style={[styles.width100, styles.box2, styles.margintop13]}>
                                    <Text style={[styles.width70, styles.font11]}>ER PF </Text>
                            ...
                            { props.userInfo.esic_check == true &&
                                <View style={[styles.width100, styles.box2, styles.margintop13]}>
                                    <Text style={[styles.width70, styles.font11]}>ER ESIC </Text>

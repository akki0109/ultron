      ...
      <div>
        ...
        <main className="offset">
          <div className="container-fluid hard-pad mb-5">
            ...
            <div className="table-scroll mt-4 pagination_mrg page_plus">
                      ...
                      <tr key={index}>
                        <td>
                          {item.projects.project_type == "Kanban" ? (
                            <Link
                              to={"/admin/taskboard/" + item.projects._id}
                              style={{ display: "block" }}
                            >
                              {item.projects.name}
                            </Link>
          ...
          <ModalBody>
            <form className="">
              <div className="form-group">
                ...
                />
                {error ? <span className="text-danger">{error.name}</span> : ""}
                {/* {this.state.error ? <span className="text-danger">{error.common ? error.common : ""}</span> : ""} */}
              </div>
              <div className="form-group">
                <label>Project Description </label>
                <textarea

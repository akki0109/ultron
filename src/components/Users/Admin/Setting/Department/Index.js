        ...
        return (
            <div>
                        ...
                        <div className="row align-items-center pt-4 border-mobile">
                            <div className="col-lg-8">
                                <ul className="submenu">
                                    ...
                                    <li className=""><Link to="/admin/settings/terminate-list">Exit</Link></li>
                                </ul>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    {departmentList && departmentList.length == 0 && loading == false &&
                                        <tr className="text-center">
                                            <td colSpan="5"> <div className="norecords">No Record Found</div> </td>
                                        </tr>
                                    }
                                </tbody>
                            </table>
                ...
                <Modal size="md" isOpen={this.state.addNewModal} toggle={() => this.addNewModalClose()}>
                    ...
                    <ModalFooter>
                        <div className="">
                            <button className="btn btn-secondary mr-3" onClick={this.addNewModalClose}>Cancel</button>
                ...
                <Modal size="md" isOpen={this.state.editModal} toggle={() => this.editModalClose()}>
                    ...
                    <ModalFooter>
                        <div className="">
                            <button className="btn btn-secondary mr-3" onClick={this.editModalClose}>Cancel</button>
                ...
                <Modal size="md" isOpen={this.state.deleteModal} toggle={() => this.deleteModalClose()}>
                    ...
                    <ModalFooter>
                        <div className="">
                            <button className="btn btn-secondary mr-3" onClick={() => this.deleteModalClose()}>Cancel</button>
                ...
                <Modal size="md" isOpen={this.state.resetPasswordModal} toggle={() => this.resetPasswordModalClose()}>
                    ...
                    <ModalFooter>
                        <div className="">
                            <button className="btn btn-secondary mr-3" onClick={this.resetPasswordModalClose}>Cancel</button>

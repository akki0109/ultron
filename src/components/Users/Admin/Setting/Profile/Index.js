...
class Index extends Component {
    ...
    getUserData() {
        this.props.dispatch(userActions.getadminById(this.state.user.data._id));
    }
    ...
    setEditUser(data) {
        this.setState({
            ...
            editImage: data.profileImage != "" && data.profileImage != undefined ? APIURL + "assets/uploads/profileImages/" + data.profileImage : ""
        });
    }
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="mt-3">
                                            {this.state.editUserData.profileImage != "" &&
                                                <img style={{ width: 200, height: "auto" }} alt="Cropped Img" src={this.state.editUserData.profileImage} />
                                            }
                                            {this.state.editUserData.profileImage == "" && this.state.editImage != "" &&
                                                <img style={{ width: 200, height: "auto" }} alt="Cropped Img" src={this.state.editImage} />
                                            }
                                        </div>
                                    </div>

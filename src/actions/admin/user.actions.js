...
//     return (dispatch) => {
//       dispatch(request());
//       adminUserService.terminateUser(userInfo).then(
...
//     function request() {
//       return { type: adminUserConstants.GETALLUSERS_REQUEST };
//     }
//     function success(user) {
//       return { type: adminUserConstants.GETALLUSERS_SUCCESS, user };
//     }
//     function failure(error) {
//       return { type: adminUserConstants.GETALLUSERS_FAILURE, error };
//     }
// }
...
function getUserListForReportingSalary(search) {
    return dispatch => {
        dispatch(request());
        adminUserService.getUserListForReportingSalary(search)
            .then(
                UserListForReporting => dispatch(success(UserListForReporting)),
                error => dispatch(failure(error))
            );

...
function forgotPassword(email) {
  ...
  function request(email) {
    return { type: userConstants.FORGOTPASSWORD_REQUEST, email };
  }
  function success(msg) {
    return { type: userConstants.FORGOTPASSWORD_SUCCESS, msg };
  }
  function failure(error) {
...
function resetPassword(resetPassword) {
  return (dispatch) => {
    ...
    userService.resetPassword(resetPassword).then(
      (msg) => {
        dispatch(success(msg));
      },
      (error) => {
